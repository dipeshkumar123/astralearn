...
export default function TeacherDashboard() {
    ...
    const statCards = [
        { label: 'Total Courses', value: stats.courses, icon: Layers, bgColor: 'bg-blue-50', iconColor: 'text-blue-600' },
        { label: 'Lessons Created', value: stats.lessons, icon: BookOpen, bgColor: 'bg-indigo-50', iconColor: 'text-indigo-600' },
        { label: 'Total Sections', value: stats.sections, icon: FileText, bgColor: 'bg-purple-50', iconColor: 'text-purple-600' },
        { label: 'Published', value: stats.published, icon: CheckCircle, bgColor: 'bg-emerald-50', iconColor: 'text-emerald-600' }
    ]

    const quickActions = [
        { title: 'My Courses', description: 'Manage your course library', icon: BookOpen, link: '/teacher/courses', color: 'from-blue-500 to-blue-600', hoverColor: 'hover:from-blue-600 hover:to-blue-700' },
        ...
        { title: 'Upload Content', description: 'Add videos and materials', icon: Upload, link: '/teacher/content-upload', color: 'from-purple-500 to-purple-600', hoverColor: 'hover:from-purple-600 hover:to-purple-700' },
