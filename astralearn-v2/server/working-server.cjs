// Working authentication server for testing
...
app.get('/health', (req, res) => {
  res.json({
    status: 'OK',
    message: 'AstraLearn v2 Working Server is running',
...
app.get('/api', (req, res) => {
  res.json({
    message: 'AstraLearn v2 Working API',
    version: '2.0.0',
    timestamp: new Date().toISOString(),
    endpoints: {
      health: 'GET /health',
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 AstraLearn v2 Working Server running on http://localhost:${PORT}`);
