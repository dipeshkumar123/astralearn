...
router.post('/', auth, authorize(['instructor', 'admin']), async (req: Request, res: Response) => {
  try {
    const {
      title,
      description,
...
router.put('/:id', auth, authorize(['instructor', 'admin']), async (req: Request, res: Response) => {
  try {
    const course = await Course.findById(req.params.id);
...
router.delete('/:id', auth, authorize(['instructor', 'admin']), async (req: Request, res: Response) => {
  try {
    const course = await Course.findById(req.params.id);
...
router.get('/my/enrolled', auth, async (req: Request, res: Response) => {
  try {
